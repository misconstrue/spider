...
class Ui_spider_view(object):
    def setupUi(self, spider_view):
        ...
        self.sortclass.setGeometry(QtCore.QRect(160, 20, 101, 22))
        ...
        self.makefile.setGeometry(QtCore.QRect(20, 50, 81, 23))
        self.makefile.setObjectName("makefile")
        self.openfile = QtWidgets.QPushButton(spider_view)
        self.openfile.setGeometry(QtCore.QRect(20, 80, 81, 23))
        self.openfile.setObjectName("openfile")
        self.textBrowser = QtWidgets.QTextBrowser(spider_view)
        self.textBrowser.setGeometry(QtCore.QRect(20, 130, 241, 331))
        self.textBrowser.setObjectName("textBrowser")
        self.guessyoulike = QtWidgets.QPushButton(spider_view)
        self.guessyoulike.setGeometry(QtCore.QRect(160, 80, 75, 23))
        self.guessyoulike.setObjectName("guessyoulike")
        self.progressBar = QtWidgets.QProgressBar(spider_view)
        self.progressBar.setGeometry(QtCore.QRect(20, 470, 241, 20))
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName("progressBar")
        self.savefile = QtWidgets.QPushButton(spider_view)
        self.savefile.setGeometry(QtCore.QRect(160, 50, 75, 23))
        ...
        self.savefile.clicked.connect(spider_view.execute_save)
    ...
    def retranslateUi(self, spider_view):
        ...
        self.savefile.setText(_translate("spider_view", "保存文件"))
